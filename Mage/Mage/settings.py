...
SECRET_KEY = 'p-n0&dk^$vpu)-qbx-@tdyn$sru22qmvr=&)g(jjh@&s)3@dgq'
...
EMAIL_HOST_USER = 'razvanazxc@gmail.com'
EMAIL_HOST_PASSWORD = 'ybolsiqonwsfxowp' #past the key or password app here
EMAIL_PORT = 587
EMAIL_USE_TLS = True
